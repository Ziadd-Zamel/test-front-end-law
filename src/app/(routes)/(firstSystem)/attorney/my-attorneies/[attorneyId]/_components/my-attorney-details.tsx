...
import { FileGeneratorButton } from "@/components/common/file-generator-button";
          ...
          <CardContent className="p-6">
            <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="font-semibold text-gray-900">ملف الوكالة</p>
                  <p className="text-sm text-gray-600">
                    {data.attorneyPdfFileName}
                  </p>
                </div>
              </div>
              <FileGeneratorButton path={data.attorneyPdfPath} />
            </div>
          </CardContent>
        </Card>
      )}
