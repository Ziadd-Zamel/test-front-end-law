...
import { UserAttorney } from "@/lib/types/attorney";
        ...
        <>
          <div className="flex items-center justify-between w-full md:gap-0 gap-6 md:flex-row flex-col">
            <div className="flex self-start items-center gap-2">
              ...
              <h2 className="text-3xl font-semibold">وكالاتي</h2>
            </div>
        ...
        <TableRow key={request.id}>
          ...
          <TableCell className="text-center">
            <div className="flex justify-center">
              <Badge variant={getBadgeVariant(request.attorneyStatus)}>
                {request.attorneyStatus}
              </Badge>
            </div>
          </TableCell>
          <TableCell className="text-center">
