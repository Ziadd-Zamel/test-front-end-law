    ...
    <TableBuilder<Attorney>
        ...
        <>
          <div className="flex items-center justify-between w-full md:gap-0 gap-6  md:flex-row flex-col">
            <div className="flex self-start items-center gap-2">
              ...
              <h2 className="text-3xl font-semibold">ادارة الطلبات</h2>
            </div>
          </div>
        </>
      }
      ...
      renderRow={(request) => (
        <TableRow key={request.id}>
          ...
          <TableCell className="text-center">
            <p className="text-sm font-medium">{request.createdAtFormatted}</p>
          </TableCell>
          <TableCell className="text-center">
          ...
          <TableCell className="text-center">
            <div className="flex items-center justify-center gap-2">
              ...
              <RevokeDialog
                attorneyId={request.id}
                attorneyNumber={request.id.toString()}
