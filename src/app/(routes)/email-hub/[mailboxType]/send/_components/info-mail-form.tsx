...
// components/mail/forms/info-mail-form.tsx (updated)
"use client";
...
import { AttachmentConfirmationDialog } from "./attachment-confirmation-dialog";
...
export function InfoMailForm({ onSuccess }: InfoMailFormProps) {
  ...
  // get all attachments for the selected case or task
