...
>(({ className, ...props }, ref) => (
  <Input
    className={cn("rounded-s-lg rounded-e-none border-l-0", className)}
    {...props}
    ref={ref}
    dir="ltr"
  />
    ...
    >
      <PopoverTrigger asChild>
        <Button
          type="button"
          variant="outline"
          className="flex gap-1 rounded-s-none rounded-e-lg px-3 focus:z-10 border-input sm:h-12 h-9"
          disabled={disabled}
        >
          <ChevronsUpDown
            className={cn(
