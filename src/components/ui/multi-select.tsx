        ...
        >
          ...
          <PopoverTrigger asChild>
            <Button
              ...
              className={cn(
                "focus-visible:border-blue-500 placeholder:text-muted-foreground flex h-auto min-h-12 items-center justify-between rounded-md border border-input bg-white p-1 hover:bg-white [&_svg]:pointer-events-auto",
          ...
          >
            <Command>
              ...
              >
                <CommandEmpty>{emptyIndicator || "لا يوجد نتائج"}</CommandEmpty>{" "}
                {!hideSelectAll && !searchValue && (
                  <CommandGroup>
                    ...
                    >
                      <div
                        className={cn(
                          "border-blue-600 mr-2 flex h-4 w-4 items-center justify-center rounded-sm border",
                          selectedValues.length ===
